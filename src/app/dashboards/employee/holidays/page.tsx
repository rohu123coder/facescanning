    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-muted-foreground">List of official holidays for the company.</p>
            </div>
            
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><CalendarDays /> Official Holiday Calendar</CardTitle>
                    <CardDescription>
