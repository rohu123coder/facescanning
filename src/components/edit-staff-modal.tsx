      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] p-0 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
            <div className="px-6 py-4">
                <Form {...form}>
                <form id="edit-staff-form" onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-x-4 gap-y-4">
                    <FormField
        ...
        <DialogFooter className="p-6 pt-4 border-t sticky bottom-0 bg-background">
            ...
            <Button type="submit" form="edit-staff-form" disabled={isLoading}>
            {isLoading ? (
                <>
