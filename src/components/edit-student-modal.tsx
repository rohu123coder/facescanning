...
export function EditStudentModal({ isOpen, onOpenChange, student, onStudentUpdated }: EditStudentModalProps) {
  ...
  const form = useForm<StudentFormValues>({
    ...
    defaultValues: {
      name: '', email: '', className: '', rollNumber: '', gender: undefined, dob: '', religion: '', fatherName: '', motherName: '', parentMobile: '', parentWhatsapp: '', photo: '',
    },
  });
